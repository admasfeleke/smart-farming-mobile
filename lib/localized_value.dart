...
class LocalizedValue {
  ...
  static const Map<String, Map<String, String>> _roles = {
    'am': {
      'farmer': 'ገበሬ',
      'super_admin': 'የስርዓት ዋና አስተዳዳሪ',
      'admin': 'የግብርና ቢሮ አስተባባሪ',
      'supporter': 'የልማት ሰራተኛ (DA)',
      'expert': 'የርዕሰ ጉዳይ ባለሙያ (SMS)',
      'field_officer': 'የመስክ ኤክስቴንሽን ሰራተኛ',
    },
    'om': {
      'farmer': 'Qonnaan bulaa',
      'super_admin': 'Bulchaa sirna olaanaa',
      'admin': 'Qindeessaa waajjira qonnaa',
      'supporter': 'Hojjetaa misoomaa (DA)',
      'expert': 'Ogeessa dhimma addaa (SMS)',
      'field_officer': 'Hojjetaa ekisteenshinii dirree',
    },
    'ti': {
      'farmer': 'ሓረስታይ',
      'super_admin': 'ዋና ኣመሓዳሪ ስርዓት',
      'admin': 'ኣተሓባባሪ ቤት ጽሕፈት ሕርሻ',
      'supporter': 'ሰራሕተኛ ልምዓት (DA)',
      'expert': 'ክኢላ ፍሉይ ዓውዲ (SMS)',
      'field_officer': 'ናይ መስክ ኤክስቴንሽን ሰራሕተኛ',
    },
    'en': {
      'farmer': 'Farmer',
      'super_admin': 'National System Administrator',
      'admin': 'Agriculture Office Coordinator',
      'supporter': 'Development Agent (DA)',
      'expert': 'Subject Matter Specialist (SMS)',
      'field_officer': 'Field Extension Officer',
    },
  };
