        ...
        return Column(
          children: [
            ListTile(
              ...
              onTap: () =>
                  Provider.of<FarmContextProvider>(context, listen: false).clearSelection(),
              trailing: onAdd == null
                  ? null
                  : IconButton(
                      onPressed: onAdd,
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              L.t(lang, 'no_plots_in', params: {'farm': farm.farmName}),
                              ...
                              children: [
                                ...
                                if (onEdit != null)
                                  IconButton(
                                    ...
                                    onPressed: () => onEdit?.call(plot),
                                  ),
                                if (onDelete != null)
                                  IconButton(
                                    icon: const Icon(Icons.delete_outline, size: 20),
                                    onPressed: () => onDelete?.call(plot),
                                  ),
